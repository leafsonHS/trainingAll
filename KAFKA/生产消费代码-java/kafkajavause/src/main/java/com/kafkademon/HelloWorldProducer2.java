 ...
 *
 */
public class HelloWorldProducer2 extends Thread {
	 public  void run() {
    ...
    // props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.160.64:9092");
     props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.100.242:9092,192.168.100.242:9093,192.168.160.64:9092,192.168.160.64:9093,192.168.160.64:9094,192.168.160.64:9095");
         ...
         props.put(ProducerConfig.CLIENT_ID_CONFIG, "1021");
//         props.put("acks", "all");
//         props.put("retries", 0);
...
//        	 
             ...
             String ip =  "111"+rnd.nextInt(25500);
